...
С помощью утилиты ls можно посмотреть списко всего содержимого директории. Другие варианты этим функцмоналом не обладают(рис. 005 ).
...
Данна якоманда передает 4 аргумента -  4 пары одинарных кавычек(рис. 027 ).
...
Чтобы создать псевдоним используем alias и соответсвенно название и команду(рис. 031 ).
...
Для последовательного выполнения команд, заданных одной строкой использюется знак ;(рис. 035 ).
...
Данное действие осуществить с помощью доллара и скобок или же одинарных кавычек(рис. 049 ).

![49](image/49.jpeg) 049  


Многоуровневое встраиване делается за счет символа доллара и кавычек(рис. 050 ).

![50](image/50.jpeg) 050  


На скриншоте видно правильное соотношеие(рис. 051 ).
...
Для получения параметром сценариев существует спциальная функция  getopts(рис. 097 ).
